    ...
    do {
        ...
        switch (choice) {
            case 1: {
                ...
                // Print the set of points we are working with
                cout << "Points: ";
                ...
                cout << "Approximate TSP solution distance: " << tspResult << endl << endl;
                break;
            }
            case 2: {
                ...
                // Print the set of vertices we are working with
                cout << "Vertices: {0, 1, 2, 3, 4}" << endl;
                cout << "Edges: { (0, 1), (0, 2), (1, 3), (2, 4) }" << endl;
            ...
            case 3: {
                ...
                // Print the universe and the sets
                cout << "Universe: { ";
                for (int x : universe) {
                    cout << x << " ";
                }
